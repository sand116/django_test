        ...
        <v-card class="elevation-12">
          ...
          <v-card-text>
            ...
            <v-form id="login-form" ref="loginForm">
              <div class="mx-3">
                <div class="mx-1">
                  <v-text-field prepend-icon="mdi-account" name="username" placeholder="user Id" type="text" ></v-text-field>
                </div>
              </div>
              <div class="mx-3">
                <div class="mx-1">
                  <v-text-field  prepend-icon="mdi-lock" name="password"  placeholder="user Password" type="password" ></v-text-field>
                </div>
              </div>
            </v-form>
          </v-card-text>
        ...
        <v-card class="elevation-12">
          ...
          <v-card-text>
            ...
            <v-form id="register-form" ref="registerForm">
              <div class="mx-3">
                <div class="mx-1">
                  <v-text-field prepend-icon="mdi-account" name="username" placeholder="user name" type="text"></v-text-field>
                </div>
              </div>
              <div class="mx-3">
                <div class="mx-1">
                  <v-text-field prepend-icon="mdi-lock" name="password1"  placeholder="password" type="password"></v-text-field>
                  <v-text-field prepend-icon="mdi-lock" name="password2" placeholder="password again" type="password"></v-text-field>
                </div>
              </div>
            </v-form>
          </v-card-text>
        ...
        <v-card class="elevation-12">
          ...
          <v-card-text>
            ...
            <v-form id="pwdchg-form" ref="pwdchgForm">
              ...
              <div class="mx-3">
                <div class="mx-1">
                  <v-text-field prepend-icon="mdi-lock" name="old_password"  placeholder="Old Password" type="password"></v-text-field>
                  <v-text-field prepend-icon="mdi-lock" name="new_password1" placeholder="New password" type="password"></v-text-field>
                  <v-text-field prepend-icon="mdi-lock" name="new_password2" placeholder="New password again" type="password"></v-text-field>
                </div>
              </div>
            </v-form>
          </v-card-text>
